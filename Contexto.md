...
- **Omisión deliberada — filas duplicadas (2026-09-20):** no se especificó qué hacer con las 1,669 filas duplicadas detectadas en el diagnóstico de datos (sección 2); se dejó como limitación conocida, sin arreglar. Costo de incluir una regla para arreglarlo: cambiaría la composición del split train/test, invalidando la comparabilidad de todas las métricas ANTES/DESPUÉS/SELECCIONADO ya generadas y documentadas.
